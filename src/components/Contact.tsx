...
export default function Contact({ contact }: ContactProps) {
  return (
    <Card title="Contato" accent className="text-center sm:text-left">
      <p className="mb-5 text-sm leading-relaxed text-black-1400 sm:text-base">
      ...
      {contact.phone && (
        <p className="mb-5 text-sm text-black-1400">
          📞 <span className="font-medium text-black-1000">{contact.phone}</span>
        </p>
      )}
